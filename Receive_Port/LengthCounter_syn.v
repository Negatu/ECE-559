...
//lpm_counter DEVICE_FAMILY="Cyclone II" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=12 aclr clock cnt_en q sclr
...
`endif
	...
	wire  [11:0]   wire_counter_reg_bit1a_regout;
	wire  [11:0]   wire_counter_reg_bit1a_sdata;
	wire  aclr_actual;
	wire clk_en;
	wire [11:0]  data;
	wire  external_cin;
	...
	assign
		wire_counter_reg_bit1a_sdata = ({12{(~ sclr)}} & (({12{sset}} & s_val) | ({12{(~ sset)}} & data)));
	assign
		aclr_actual = aclr,
		clk_en = 1'b1,
		data = {12{1'b0}},
...
module LengthCounter (
	...
	LengthCounter_cntr	LengthCounter_cntr_component (
				.sclr (sclr),
				.aclr (aclr),
				.clock (clock),
				.cnt_en (cnt_en),
